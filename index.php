			...
			<form action="" method="POST">
				...
				<div>
					...
					<div class="tel-div">
						...
						<input id="tel2" type="tel" name="phone_num2" value=""></label>
					</div>
				</div>
				...
				<label for="rb-div">Пол</label>

				<br>

				<div class="rb-div">
					<input type="radio" name="gender" id="male" value="male" checked>
					<label for="male" class="rb-label" style="margin-right: 10px;">
						<p class="gender-text">Мужской</p>
					</label>

					<input type="radio" name="gender" id="female" value="female">
					<label for="female" class="rb-label">
						<p class="gender-text">Женский</p>
					</label>
				</div>
